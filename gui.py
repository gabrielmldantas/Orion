...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.labelInstruction = QtGui.QLabel(self.groupBox)
        self.labelInstruction.setObjectName(_fromUtf8("labelInstruction"))
        self.formLayout_2.setWidget(12, QtGui.QFormLayout.LabelRole, self.labelInstruction)
        self.lineEditInstruction = QtGui.QLineEdit(self.groupBox)
        self.lineEditInstruction.setReadOnly(True)
        self.lineEditInstruction.setObjectName(_fromUtf8("lineEditInstruction"))
        self.formLayout_2.setWidget(12, QtGui.QFormLayout.FieldRole, self.lineEditInstruction)
        self.pushButtonNext = QtGui.QPushButton(self.groupBox)
        self.pushButtonNext.setObjectName(_fromUtf8("pushButtonNext"))
        self.formLayout_2.setWidget(13, QtGui.QFormLayout.FieldRole, self.pushButtonNext)
    ...
    def retranslateUi(self, window):
        ...
        self.labelInstruction.setText(_translate("window", "Instrução Atual", None))
